            ...
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapsed d-flex flex-row-reverse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="albumadmincreapersonal.php">Album-CreaPersonal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="albumadminborrapersonal.php">Album-BorraPersonal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="admincreapersonal.php">Crea-CuentaPersonal</a>
                        </li>
                        <li class="nav-item">
